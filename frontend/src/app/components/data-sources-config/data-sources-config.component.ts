    ...
    const config: DataSourcesConfig = {
      firstTermSourceConfig: {
        ...
        googleSheetsConfig: {
          ...
          descriptionColumn: this.descriptionColumnGoogleSheetsFirstTermFormControl.value !== '' ? this.descriptionColumnGoogleSheetsFirstTermFormControl.value : null,
          skuColumn: this.skuColumnGoogleSheetsFirstTermFormControl.value !== '' ? this.skuColumnGoogleSheetsFirstTermFormControl.value : null,
          urlColumn: this.urlColumnGoogleSheetsFirstTermFormControl.value !== '' ? this.urlColumnGoogleSheetsFirstTermFormControl.value : null,
          imageUrlColumn: this.imageUrlColumnGoogleSheetsFirstTermFormControl.value !== '' ? this.imageUrlColumnGoogleSheetsFirstTermFormControl.value : null,
        },
        bigQueryConfig: {
          ...
          descriptionColumn: this.descriptionColumnBigQueryFirstTermFormControl.value !== '' ? this.descriptionColumnBigQueryFirstTermFormControl.value : null,
          skuColumn: this.skuColumnBigQueryFirstTermFormControl.value !== '' ? this.skuColumnBigQueryFirstTermFormControl.value : null,
          urlColumn: this.urlColumnBigQueryFirstTermFormControl.value !== '' ? this.urlColumnBigQueryFirstTermFormControl.value : null,
          imageUrlColumn: this.imageUrlColumnBigQueryFirstTermFormControl.value !== '' ? this.imageUrlColumnBigQueryFirstTermFormControl.value : null,
          limit: this.limitBigQueryFirstTermFormControl.value !== '' ? Number(this.limitBigQueryFirstTermFormControl.value) : null,
        },
        listOfTermsConfig: {
    ...
    if (this.mustShowSecondTermConfig) {
      config['secondTermSourceConfig'] = {
        ...
        googleSheetsConfig: {
          ...
          descriptionColumn: this.descriptionColumnGoogleSheetsSecondTermFormControl.value !== '' ? this.descriptionColumnGoogleSheetsSecondTermFormControl.value : null,
        ...
        bigQueryConfig: {
          ...
          descriptionColumn: this.descriptionColumnBigQuerySecondTermFormControl.value !== '' ? this.descriptionColumnBigQuerySecondTermFormControl.value : null,
          limit: this.limitBigQuerySecondTermFormControl.value !== '' ? Number(this.limitBigQuerySecondTermFormControl.value) : null,
        },
        googleTrendsConfig: {
